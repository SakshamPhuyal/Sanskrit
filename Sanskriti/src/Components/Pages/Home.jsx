...
<button className='text-black text-2xl bg-orange-100 + drop-shadow-lg h-15 w-35 border-2 border-black cursor-pointer rounded-lg'>Shop Now</button>
<button className='text-black text-2xl bg-orange-100 + drop-shadow-lg h-15  w-35 border-2 border-black cursor-pointer rounded-lg'>Explore</button>
   </div>
    </div>
    </div>
  )
